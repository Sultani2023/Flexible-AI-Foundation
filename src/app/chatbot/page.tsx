...
export default function MiniProjectChatbotPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-100 via-purple-100 to-pink-100 py-12 px-6">

      {/* Back Button */}
      <div className="max-w-4xl mx-auto mb-6">
        <Link href="/modules">
          <button className="flex items-center gap-2 text-indigo-700 hover:underline">
            <ArrowLeft size={20} />
            Back to Modules
          </button>
        </Link>
      ...
      <div className="max-w-4xl mx-auto bg-white/70 backdrop-blur-lg shadow-xl rounded-2xl p-8 space-y-12">
        ...
        <section>
          ...
          <h2 className="text-xl font-semibold text-purple-600 mb-2">📌 What You Will Learn</h2>
          ...
          <h2 className="text-xl font-semibold text-purple-600 mt-6 mb-2">🛠 Tools Used</h2>
          <ul className="list-disc ml-6 text-gray-700 space-y-1">
            <li>React (Next.js)</li>
            <li>State management with useState</li>
            <li>Simple logic to generate bot replies</li>
          </ul>

          <h2 className="text-xl font-semibold text-purple-600 mt-6 mb-2">🎯 Example Output</h2>
          ...
          <a href="#chatbot-demo">
            <button className="mt-6 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-xl shadow-md">
              Start Project 🚀
            </button>
          </a>
        </section>
        ...
        <section id="chatbot-demo">
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              className="flex-1 px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-purple-400"
